//------------------------------------------------------------------------------
// <copyright file="TodoWindowCommand.cs" company="Company">
...
namespace todolist
{
    ...
    internal sealed class TodoWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("962cc4e0-4728-4034-86c1-9a4b152f674d");
        ...
        private TodoWindowCommand(Package package)
        {
            if (package == null)
            {
        ...
        {
            Instance = new TodoWindowCommand(package);
        }
